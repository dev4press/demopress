    ...
    <?php if ($_task == 'index' && demopress_gen()->is_idle()) { ?>
        <div class=" d4p-plugin-dashboard">
            <div class="d4p-dashboard-badge" style="background-color: #583d48">
                <div aria-hidden="true" class="d4p-plugin-logo"><i class="d4p-icon d4p-plugin-icon-gd-demo-data-generator"></i></div>
            ...
            <div class="d4p-buttons-group">
                <a class="button-secondary" href="options-general.php?page=demopress&panel=settings"><i aria-hidden="true" class="fa fa-cogs fa-fw"></i> <?php _e("Settings", "demopress"); ?></a>
                <a class="button-secondary" href="options-general.php?page=demopress&panel=tools"><i aria-hidden="true" class="fa fa-wrench fa-fw"></i> <?php _e("Tools", "demopress"); ?></a>
                <a class="button-secondary" href="options-general.php?page=demopress&panel=about"><i aria-hidden="true" class="fa fa-info-circle fa-fw"></i> <?php _e("About", "demopress"); ?></a>
            </div>
        </div>
    ...
    if (demopress_gen()->is_idle()) {
        ...
        <div class="demopress-generator-panel demopress-gen-status-<?php echo $_status; ?>">
            <div class="demopress-gen-header">
                <?php _e("Generator", "demopress"); ?>: <strong><?php echo demopress()->get_generator_label(demopress_gen()->type); ?></strong>
                <br/><?php _e("Started", "demopress"); ?>: <strong><?php echo date("c", demopress_gen()->started); ?></strong>
                <?php if (!demopress_gen()->is_running()) { ?><br/><?php _e("Ended", "demopress"); ?>: <strong><?php echo date("c", demopress_gen()->ended); ?></strong><?php } ?>
            </div>
            ...
            <div class="demopress-gen-loader"><i class="fa fa-spinner fa-fw fa-spin"></i> <?php _e("Checking progress...", "demopress"); ?></div>
        </div>
